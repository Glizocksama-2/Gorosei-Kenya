...
export const FIXED_PRICE = PRODUCT_PRICES.tshirt;
...
export const FIT_CHECK_MEDIA = [
  { src: "/fit-check-1.webp", title: "Amaterasu sky fit check" },
  { src: "/fit-check-2.webp", title: "Ben 10 green jacket fit check" },
